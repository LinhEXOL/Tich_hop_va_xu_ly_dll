...
def crawl_to_dataframe(query_url_template: str, start_page: int = 1, end_page: int = 1,
    ...
    for page in range(start_page, end_page + 1):
        ...
        for j in jobs:
            ...
            print(len(seen_jobs)," --", j["detail_title"] if "detail_title" in j else j["title"])
...
if __name__ == "__main__":
    ...
    qtpl = "https://www.topcv.vn/tim-viec-lam-cong-nghe-thong-tin-cr257?category_family=r257&page={page}"
    df = crawl_to_dataframe(qtpl, start_page=1, end_page=70, delay_between_pages=(0.5, 1))

    # Ánh xạ cột trong DataFrame -> nhãn tiếng Việt cần xuất
    RENAME_MAP = {
        "stt": "stt",
